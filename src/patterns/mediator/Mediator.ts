...
module puremvc
{
		...
		implements IMediator, INotifier
	{
		 ...
		 */
		constructor(mediatorName:string=NullStr, viewComponent:any=null)
		{
			super();

			this._mediatorName = (mediatorName != NullStr) ? mediatorName : Mediator.NAME;
		 ...
		 */
		listNotificationInterests():Array<ENotify>
		{
			return new Array<ENotify>();
		}
		 ...
		 * @constant
		 */
		static readonly NAME:string = 'Mediator';
	}
}